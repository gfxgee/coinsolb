...
class Ion_auth_model extends CI_Model
{
	...
	public function register($identity, $password, $email, $additional_data = [], $groups = [])
	{
		...
		if ( $id ) $this->coin_solve_model->generate_referral_code( $id );

		if ( $id && $additional_data['referral_code'] ) $this->coin_solve_model->record_user_referral( $id , $additional_data['referral_code'] );
