...
<?php 
	...
	$questions = array (
		...
		'2'	=> array (
			...
			'faq_content'	=> '<p>Upon signing up your account on Coinsolb the system will automatically generates a code (which will serve as your referral code) that you can use to share the our application to other and earn addition extra points.</p> <a href="'.base_url('discussion').'" class="link-primary fs-16"> Continue here.</a>' ),
		'3'	=> array (
		...
		'4'	=> array (
			...
			'faq_content'	=> '<p>Yes it is absolutely free to use. We at Coinsolb wants to help out those who are needing improvements on their basic math skills.</p><a href="'.base_url('discussion').'" class="link-primary fs-16"> Learn more.</a>' ),
		'5'	=> array (
		...
		'7'	=> array (
			...
			'faq_content'	=> '<p>You can find the total of all your points in the points tab under you account dashboard but be sure to login.</p><p> Go to my <a href="'.base_url('discussion').'" class="fs-16 link-primary">Points Tab</a></p>' ),
		'8'	=> array (
